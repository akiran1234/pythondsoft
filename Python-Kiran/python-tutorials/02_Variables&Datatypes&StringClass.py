...
# Updating & Deleting  the string object is valid but updating & deleting the string indexing characters is in valid because of it's immutable nature.
# Refer the difference for bytes and strings from this url- https://pyhurry.readthedocs.io/en/latest/strings.html
